...
const Body = () => {
    ...
    return (
        <>
            ...
            <div className='bg-gray-100 flex flex-col space-y-3 sm:space-y-0 sm:flex-row justify-center sm:justify-between text-center sm:text-left px-0 py-20 sm:px-96 sm:py-20 items-center '>
            ...
            <div className='bg-black text-white flex flex-col items-center space-y-3  sm:space-y-0 sm:flex-row justify-center sm:justify-around px-0 py-20 sm:px-96 sm:py-20 mt-20'>
