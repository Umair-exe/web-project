...
const Footer = () => {
    return (
        <>
            <div className='mt-48 bg-stone-900 text-white flex flex-col sm:flex-row sm:justify-evenly items-center space-y-3 space-x-6 sm:space-y-0  px-0 py-20 sm:px-96 sm:py-20 '>
