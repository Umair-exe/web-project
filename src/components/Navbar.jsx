...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-center sm:justify-evenly items-center p-0 sm:p-4  bg-stone-900 text-white top-0 sticky z-20 transition duration-500'>
            ...
            {toggleMenu && (
                ...
                flex flex-col justify-start items-center space-y-5 rounded-md bg-stone-900 text-white ">
                    ...
                    <h1 className='hover:transition hover:duration-300  w-full px-4 py-2 cursor-pointer hover:bg-white hover:text-black hover:border-b-4 hover:border-sky-500 hover:bg-transparent hover:text-white  '>HOME</h1>
                    <h1 className='hover:transition hover:duration-300  w-full px-4 py-2 cursor-pointer hover:bg-white hover:text-black hover:border-b-4 hover:border-sky-500 hover:bg-transparent hover:text-white' >ABOUT US</h1>
